	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="register-section" id="basic-details-section">
				...
				<label for="signup_username"><?php _e( 'Username', 'buddypress' ); ?> <?php _e( '<span class="red-asterisk" aria-hidden="true">*</span><span class="screen-reader-text">(required)</span>', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_email"><?php _e( 'Email Address', 'buddypress' ); ?> <?php _e( '<span class="red-asterisk" aria-hidden="true">*</span><span class="screen-reader-text">(required)</span>', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_password"><?php _e( 'Choose a Password', 'buddypress' ); ?> <?php _e( '<span class="red-asterisk" aria-hidden="true">*</span><span class="screen-reader-text">(required)</span>', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_password_confirm"><?php _e( 'Confirm Password', 'buddypress' ); ?> <?php _e( '<span class="red-asterisk" aria-hidden="true">*</span><span class="screen-reader-text">(required)</span>', 'buddypress' ); ?></label>
				<?php
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section" id="blog-details-section">
					...
					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
						...
						<label for="signup_blog_url"><?php _e( 'Blog URL', 'buddypress' ); ?> <?php _e( '<span class="red-asterisk" aria-hidden="true">*</span><span class="screen-reader-text">(required)</span>', 'buddypress' ); ?></label>
						<?php
						...
						<label for="signup_blog_title"><?php _e( 'Site Title', 'buddypress' ); ?> <?php _e( '<span class="red-asterisk" aria-hidden="true">*</span><span class="screen-reader-text">(required)</span>', 'buddypress' ); ?></label>
						<?php
