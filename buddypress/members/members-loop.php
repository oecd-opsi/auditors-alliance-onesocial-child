			...
			<?php while ( bp_members() ) : bp_the_member(); ?>
				...
				<li>
					...
					<div class="item">
						...
						<div class="item-desc">
							<?php
							$user_organisation = bp_get_profile_field_data( array( 'field' => 274, 'user_id' => $user_id ) );
							$user_function = bp_get_profile_field_data( array( 'field' => 287, 'user_id' => $user_id ) );
							if ( 'Other' == $user_function ) {
								$user_function = bp_get_profile_field_data( array( 'field' => 367, 'user_id' => $user_id ) );
							}
							?>
								<div class="member-meta"><strong><?php echo $user_organisation ?></strong><br/><?php echo $user_function ?></div>
							<?php
							?>
						</div>
